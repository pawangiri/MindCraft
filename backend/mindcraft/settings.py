...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "mindcraft-dev-secret-key-change-in-production")
DEBUG = True
ALLOWED_HOSTS = ["*"]
...
WSGI_APPLICATION = "mindcraft.wsgi.application"
